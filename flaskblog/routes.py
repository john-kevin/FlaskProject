...
def home():
    ...
    date_posted_desc = Post.date_posted.desc()
    from_first_post_to_newest_post = Post.query.order_by(date_posted_desc)
    posts = from_first_post_to_newest_post.paginate(per_page=5, page=page)
...
def save_picture(form_picture):
    ...
    picture_fn = random_hex + '-SALT-' + str(datetime.now()) + f_ext
