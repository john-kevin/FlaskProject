...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        # invalidate_token(token, session_id?)
        # set session first after token generation
        # ???validate that the user who generated the token is the one who used it
        # ^ or this is already handled by cory schafer somwhere in here...
        return redirect(url_for('users.login'))
